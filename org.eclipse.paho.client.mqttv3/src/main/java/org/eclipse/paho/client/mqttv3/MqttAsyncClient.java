...
//				}
		...
		case MqttConnectOptions.URI_TYPE_WS:
			...
			netModule = new WebSocketNetworkModule(factory, address, host, port, clientId, options.getCustomHeaders());
		...
		case MqttConnectOptions.URI_TYPE_WSS:
			...
			// Create the network module...
			netModule = new WebSocketSecureNetworkModule((SSLSocketFactory) factory, address, host, port, clientId, options.getCustomHeaders());
