 ...
 */
package org.eclipse.paho.client.mqttv3.internal.logging;
...
public interface Logger {
	 ...
	 *            Throwable associated with log message.
	 * @param fatal
	 *            True if the FFDC handler should shutdown/restart the component
	 *            that issued the FFDC.
	 */
	public void ffdc(String sourceClass, String sourceMethod, String msg, Object[] inserts, Throwable thrown, boolean fatal);
	 ...
	 *            that issued the FFDC.
	 */
	public void ffdc(String sourceClass, String sourceMethod, Throwable thrown, boolean fatal);
	 ...
	 *            Name of method that issued the logging request.
	 * @param theThread
	 *            The Thread which caused the problem. If that is the current
	 *            thread, use the method without a Thread: @see
	 *            {@link #ffdc(String sourceClass, String sourceMethod, Throwable thrown, boolean fatal)}.
	 * @param thrown
	 *            Throwable associated with log message.
	 * @param fatal
	 *            True if the FFDC handler should shutdown/restart the component
	 *            that issued the FFDC.
	 */
	public void ffdc(String sourceClass, String sourceMethod, Thread theThread, Throwable thrown, boolean fatal);
