 ...
 * </p>
 * <p>If connecting with {@link MqttConnectionOptions#setCleanSession(boolean)} set to true it
...
public class MqttLegacyBlockingClient implements IMqttClient { //), DestinationProvider {
	 ...
	 * {@link MqttConnectionOptions#setServerURIs(String[]) setServerURIs} method
	 ...
	 * use {@link MqttConnectionOptions#setSocketFactory(SocketFactory)} to supply
	 * a factory with the appropriate SSL settings.</li>
	 * 	<li><strong>SSL Properties</strong> - applications can supply SSL settings as a
	 * simple Java Properties using {@link MqttConnectionOptions#setSSLProperties(Properties)}.</li>
	 ...
	 * addition {@link MqttConnectionOptions#setCleanSession(boolean)} must be set
	 ...
	 * @throws MqttException if any other problem was encountered
	 */
	public MqttLegacyBlockingClient(String serverURI, String clientId, MqttClientPersistence persistence) throws MqttException {
