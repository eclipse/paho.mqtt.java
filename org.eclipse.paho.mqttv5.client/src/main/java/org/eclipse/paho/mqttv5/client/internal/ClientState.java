...
public class ClientState implements MqttState {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#send(org.eclipse.paho.client.mqttv3.internal.wire.MqttWireMessage, org.eclipse.paho.client.mqttv3.MqttToken)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#persistBufferedMessage(org.eclipse.paho.client.mqttv3.internal.wire.MqttWireMessage)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#unPersistBufferedMessage(org.eclipse.paho.client.mqttv3.internal.wire.MqttWireMessage)
	 */
	@Override
...
//				checkForActivity(); //Use pinger, don't check here
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#setKeepAliveInterval(long)
	 */
	@Override
...
//		if (quiescing && actualInFlight == 0 && pendingFlows.size() == 0 && inFlightPubRels == 0 && callback.isQuiesced()) {
    ...
    /* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#notifyReceivedBytes(int)
	 */
    @Override
		...
		if (!quiescing) {
			if (message instanceof MqttPublish) {
				...
				if (sendMsg != null) {
					...
					MqttPubComp pubComp = new MqttPubComp(MqttReturnCode.RETURN_CODE_SUCCESS, message
							.getMessageId());
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#resolveOldTokens(org.eclipse.paho.client.mqttv3.MqttException)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.mqttv3.internal.MqttState#disconnected(org.eclipse.paho.client.mqttv3.MqttException)
	 */
	@Override
